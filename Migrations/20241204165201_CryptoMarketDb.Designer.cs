...
namespace RealEstate_Mvc_.Migrations
{
    ...
    [Migration("20241204165201_CryptoMarketDb")]
    partial class CryptoMarketDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealEstateMvc.Models.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "abcd",
                            CreatedBy = "Wahab",
                            DateCrated = new DateTime(2024, 12, 4, 17, 51, 59, 588, DateTimeKind.Local).AddTicks(7302),
                        ...
                        new
                        {
                            Id = "abcd123",
                            CreatedBy = "Wahab",
                            DateCrated = new DateTime(2024, 12, 4, 17, 51, 59, 588, DateTimeKind.Local).AddTicks(7412),
            ...
            modelBuilder.Entity("RealEstateMvc.Models.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "abcd",
                            CreatedBy = "Wahab",
                            DateDeleted = new DateTime(2024, 12, 4, 17, 51, 59, 588, DateTimeKind.Local).AddTicks(7062),
            ...
            modelBuilder.Entity("RealEstateMvc.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "Super001",
                            CreatedBy = "Wahab",
                            DateCrated = new DateTime(2024, 12, 4, 17, 51, 59, 382, DateTimeKind.Local).AddTicks(5369),
                            Email = "SuperAdmin@gmail.com",
                            FullName = "JokosenumiAbdulWahab",
                            IsDeleted = false,
                            Password = "$2a$11$IzE8meu48VteKHlygHnrPOq2nJ2jVRrZnkxq.Y3gMINhJeTTFyPWK"
                        });
                });
            ...
            modelBuilder.Entity("RealEstate_Mvc_.Models.Entities.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "Abk",
                            Age = 17,
                            DateCrated = new DateTime(2024, 12, 4, 17, 51, 59, 382, DateTimeKind.Local).AddTicks(5157),
                            DeletedBy = "Wahab",
            ...
            modelBuilder.Entity("RealEstate_Mvc_.Models.Entities.Wallet", b =>
                {
                    b.HasOne("RealEstateMvc.Models.Entities.Customer", null)
                        .WithOne("Wallet")
                        .HasForeignKey("RealEstate_Mvc_.Models.Entities.Wallet", "CustomerId");
                });
